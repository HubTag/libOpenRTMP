...
static amf_err_t amf0_write_string_internal( ors_data_t* dest, byte type, void *value, size_t value_len ){
    byte header[5];
    int len = 3;
    header[0] = AMF0_TYPE_STRING;
    if( value_len > 0xFFFF || type == AMF0_TYPE_XML_DOCUMENT ){
        header[0] = type == AMF0_TYPE_XML_DOCUMENT ? AMF0_TYPE_XML_DOCUMENT : AMF0_TYPE_LONG_STRING;
...
amf_err_t amf0_write_string( ors_data_t* dest, void *value, size_t value_len ){
    return amf0_write_string_internal( dest, AMF0_TYPE_STRING, value, value_len );
}
...
amf_err_t amf0_write_long_string( ors_data_t* dest, void *value, size_t value_len){
    return amf0_write_string_internal( dest, AMF0_TYPE_LONG_STRING, value, value_len );
}

//Alias around amf0_write_string_internal
amf_err_t amf0_write_xmldocument( ors_data_t* dest, void *value, size_t value_len){
    return amf0_write_string_internal( dest, AMF0_TYPE_XML_DOCUMENT, value, value_len );
}
